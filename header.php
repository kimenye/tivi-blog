		...
		<div class="row container">
			<div class="twelve columns">
				<header role="banner" id="top-header">
					...
					<div class="siteinfo">
						<a href="<?php echo get_bloginfo('url'); ?>"><div class="logo"></div></a>
						<!--<h1><a class="brand" id="logo" href="<?php echo get_bloginfo('url'); ?>"></a></h1>-->
						<h5 class="subhead"><?php echo get_bloginfo ( 'description' ); ?></h5>
					</div>
